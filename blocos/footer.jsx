        ...
        <footer className="bg-black border-t border-white/5 pt-16 md:pt-20 pb-10">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-16">
                    ...
                    <div className="group">
                        <h4 className="text-white font-bold mb-6 flex items-center gap-2 group-hover:text-maresia-blue transition-colors">
                            <MapPin size={16} className="text-maresia-blue" /> Adega (Varejo)
                        </h4>
                        <address className="not-italic text-slate-500 text-sm space-y-2">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <a href="tel:13997739347" className="flex items-center gap-3 text-slate-500 hover:text-white transition-colors group">
                            ...
                            <a href="tel:13991868515" className="flex items-center gap-3 text-slate-500 hover:text-white transition-colors group">
                                <div className="p-2 rounded-lg bg-white/5 group-hover:bg-maresia-blue/10 transition-colors">
                                    <Phone size={14} className="text-maresia-blue" />
                                </div>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-slate-600 text-[9px] md:text-[10px] uppercase tracking-[0.2em] text-center md:text-left">
                        © 2026 MARESIA BEBIDAS — TODOS OS DIREITOS RESERVADOS
                    </p>

                    <motion.div
                        onClick={() => window.open('https://luansouzadev.com.br', '_blank')}
                        whileHover={{ y: -2 }}
                        className="group cursor-pointer flex items-center gap-2 text-slate-500 text-[9px] md:text-[10px] uppercase tracking-[0.2em]"
                    >
                        <span>Powered by</span>
                        <span className="text-white font-bold group-hover:text-maresia-blue transition-colors underline underline-offset-4 decoration-maresia-blue/30">
                            Luan Souza Dev
                        </span>
                    </motion.div>
                </div>
